                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="search_box pull-right">
                            ...
                            <input type="submit" style="margin-top:0;color:#666666" name="search_items" class="btn btn-primary btn-sm" value="Tìm kiếm">
                        </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="single-widget">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="#">Chính sách đôi trả</a></li>
                    ...
                    <div class="col-sm-2">
                        <div class="single-widget">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="#">Địa chỉ: Tràng Tiền Plaza, 24 Hai Bà Trưng, Hoàn Kiếm, Hà Nội <Tiền></Tiền></a></li>
                                <li><a href="tel: +84834703555">Điện Thoại: 0834703555</a></li>
                                <li><a href="https://www.facebook.com/BeerSneaker20">fb.com/BeerSneaker20</a></li>
                                <li><a href="mailto: luonghuythong1994@gmail.com">Send Mail</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-2">
