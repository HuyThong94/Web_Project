...
<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-5">
                            <ul id="imageGallery">
                                ...
                                <li data-thumb="{{asset('public/frontend/images/ao2.jpg')}}" data-src="{{asset('public/frontend/images/ao2.jpg')}}">
                                    <img width="100%" src="{{asset('public/frontend/images/ao2.jpg')}}" />
                                </li>
                                <li data-thumb="{{asset('public/frontend/images/ao3.jpg')}}" data-src="{{asset('public/frontend/images/ao3.jpg')}}">
                                    <img width="100%" src="{{asset('public/frontend/images/ao3.jpg')}}" />
                                </li>
                                <li data-thumb="{{asset('public/frontend/images/ao1.jpg')}}" data-src="{{asset('public/frontend/images/ao1.jpg')}}">
                                    <img width="100%" src="{{asset('public/frontend/images/ao1.jpg')}}" />
                                </li>
